...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" style="background-color:#0092b3!important; color:#fefefe;">
            <div class="container">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a href="{{ url('/mycart') }}" class="dropdown-item">カートを見る</a>
                                </div>
                            </li>
                            <a href="{{ url('/mycart') }}">
